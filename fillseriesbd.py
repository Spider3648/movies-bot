...
c.execute('''CREATE TABLE IF NOT EXISTS Series
             (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT, god TEXT, OPISANIE TEXT, LINK_STR TEXT)''')

# Базова URL-адреса для фільмів
base_url = "https://uaserials.pro/series/page/"
...
for page_num in range(1, 6):
    ...
    for movie in movies:
        c.execute("INSERT INTO Series (name, god, OPISANIE, LINK_STR) VALUES (?, ?, ?, ?)",
